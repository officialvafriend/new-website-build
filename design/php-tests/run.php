...
$ok($ns[0]['eb'] === '고객센터' && $ns[0]['k'] === '평일 11:00–18:00' && str_contains($ns[0]['s'], '점심 12:00–13:00') && str_contains($ns[0]['s'], '휴무') && $ns[1]['eb'] === '배송' && str_contains($ns[1]['k'], '월요일') && $ns[2]['k'] === '가격이 인상되었습니다' && str_contains($ns[2]['s'], '낱병 13,000원') && str_contains($ns[2]['s'], '블랙 10+1 130,000원') && !str_contains($ns[2]['s'], '노보 낱병'), '카드: 이름표 · 굵은 한 줄 · 회색 한 줄 — 누르지 않아도 핵심이 다 읽힌다');
...
$h = ($F.'notice_bar_html')();
$ok(substr_count($h, 'class="dhn__card"') === 3 && substr_count($h, '<a class="dhn__card"') === 3 && str_contains($h, 'data-dhn="') && str_contains($h, 'data-dhn-close') && !str_contains($h, 'aria-expanded') && substr_count($h, 'class="dhn__s"') === 3, '띠: 카드 셋(전부 링크) · 해시 · 닫기 · 접는 것 없음');
