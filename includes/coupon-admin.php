...
function screen(): void {
	...
	echo '<p>금액 목록을 붙여 넣으면 <b>워드커머스 쿠폰</b>을 그만큼 만들고, 문자에 붙여 넣을 목록까지 뽑습니다. '
		. '손님이 코드를 넣는 자리는 <b>두 곳</b>입니다 — <b>장바구니</b>(우리가 만든 칸)와 <b>결제 화면</b>(테마가 원래 그리는 칸). '
		. '어느 쪽에 넣든 같은 장바구니에 붙어 결제 금액에 똑같이 반영됩니다. '
		. '문자 문구는 <b>장바구니</b>를 안내합니다 — 손님이 먼저 만나는 화면이고, <b>비회원도 거기서는 할인된 금액을 볼 수 있습니다</b> '
		. '(결제 화면은 로그인해야 들어갑니다). 무통장입금이라 <b>입금할 금액을 미리 아는 것</b>이 중요합니다. '
		. '결제 화면으로 안내하고 싶으시면 아래 문자 문구만 고치면 됩니다. 코드는 대소문자를 가리지 않습니다.</p>';
