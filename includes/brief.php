...
function rules(): array {
	return (array) apply_filters( 'duckhoo_brief_rules', array(
		...
		'사장님이 2026-09-24 에 더 못 박은 것 — 다시 제안하지 말 것: 업자(소매점 · 도매 · 사업자 채널)에게 파는 것은 절대 없음, 무니코틴으로 갈아타는 기획(검색은 많지만 실제로 안 팔린다 — 업계 공통), 문자 · 쿠폰 · 리마인드 같은 CRM(이미 해 봤고 돌아온 것이 없다), 니코틴 재고를 비싸게 오래 파는 것(목표는 빨리 현금화).',
		'지금 방향(2026-09-24): 2026-04-24 개정 담배사업법으로 합성니코틴 액상은 온라인 판매가 금지됐고 지금 파는 것은 법 시행 전 재고뿐 — 재입고가 없다. 목표는 그 재고를 정부 기한이 오기 전에 소매 손님에게 빨리 파는 것. 막는 것은 값이다: 우리는 시장(브이몬스터 · 겨울마을)보다 10~70% 비싸다(노보 낱병 13,000 vs 11,500 · 9,000). 도구 → 시장가 대조로 값을 맞춘다. 무니코틴 · 유사니코틴(닉소다인) 전환은 없다.',
		...
		'액상덕후만 생각한다. 이 계정에 같이 있는 베이프렌드(오프라인 매장 · 블로그)는 별개 사업이다 — 매장 QR · 블로그 링크 같은 연계를 제안하지 않고, 이름도 꺼내지 않는다 (사장님 2026-09-24).',
